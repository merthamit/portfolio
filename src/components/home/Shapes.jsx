  ...
  return (
    <div className="shapes">
      <svg
        ...
        className="shape s1"
        style={{
          transform: `translateX(${(x * 15) / 250}px) translateY(${
            (y * 15) / 250
          }px)`,
        }}
      ...
      <svg
        ...
        height="26"
        style={{
          transform: `translateX(${(x * 10) / 250}px) translateY(${
            (y * 10) / 250
          }px)`,
        }}
        className="shape s2"
      ...
      <svg
        ...
        height="25"
        style={{
          transform: `translateX(${(x * 11) / 250}px) translateY(${
            (y * 11) / 250
          }px)`,
        }}
        className="shape s3"
      ...
      <svg
        ...
        height="23"
        style={{
          transform: `translateX(${(x * -7) / 250}px) translateY(${
            (y * -7) / 250
          }px)`,
        }}
        className="shape s4"
      ...
      <svg
        ...
        height="23"
        style={{
          transform: `translateX(${(x * 3) / 250}px) translateY(${
            (y * 3) / 250
          }px)`,
        }}
        className="shape s5"
      ...
      <svg
        ...
        height="17"
        style={{
          transform: `translateX(${(x * -9) / 250}px) translateY(${
            (y * -9) / 250
          }px)`,
        }}
        className="shape s6"
      ...
      <svg
        width="30"
        style={{
          transform: `translateX(${(x * -5) / 250}px) translateY(${
            (y * -5) / 250
          }px)`,
        }}
        height="25"
